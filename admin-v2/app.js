...
(function () {
  ...
  function erdynTrame() {
    var L = [
      ...
      "« Merci d'avoir pris le temps pour cet échange. J'ai bien parcouru le cahier des charges, qui est déjà très complet. J'avais surtout quelques questions pour préciser certains points avant de préparer mon devis et être sûre de te proposer quelque chose qui corresponde vraiment à tes besoins. »",
      "",
      ...
      "« Au-delà des objectifs présentés dans le cahier des charges, qu'aimerais-tu concrètement que le site permette au projet SERENITY ? Qu'est-ce qui te ferait dire, dans quelques mois, qu'il remplit vraiment son rôle ? »",
      "Si la réponse reste vague :",
      "« Est-ce que l'objectif est surtout d'avoir une vitrine officielle vers laquelle renvoyer depuis tes communications et celles des partenaires, ou est-ce que tu souhaites aussi que de nouvelles personnes puissent découvrir SERENITY par elles-mêmes ? »",
      "",
      "③ SEO ET VISIBILITÉ",
      "SEULEMENT si sa réponse montre qu'ils veulent être découverts au-delà de leur réseau. Sinon, passe.",
      "« Est-ce que tu as déjà prévu un accompagnement concernant le référencement naturel et la rédaction des contenus ? »",
      "Si non, tu expliques :",
      "« Si tu souhaites que le projet puisse être découvert via les moteurs de recherche, je te conseillerais de travailler cette partie dès la conception. De mon côté, je peux prévoir les bonnes bases techniques et la structure du site, et pour la stratégie de contenus et leur optimisation, je recommande généralement l'intervention d'une rédactrice SEO. »",
      "",
      "④ LIBERTÉ SUR L'ARBORESCENCE ET L'UX",
      "Détermine si tu intègres une phase UX et conseil dans le devis.",
      "« J'ai vu que tu avais déjà défini une première arborescence avec les différentes pages. Est-ce qu'elle est complètement arrêtée ou est-ce que tu es ouverte à ce que je te fasse des recommandations si j'identifie des possibilités d'améliorer la navigation, la structure ou l'organisation des contenus ? »",
      "Puis éventuellement :",
      "« Plus globalement, est-ce que tu attends surtout de moi la réalisation du cahier des charges tel qu'il est aujourd'hui, ou est-ce que tu souhaites aussi que j'apporte un regard conseil sur l'UX et la structure du site ? »",
      "",
      ...
      "« Est-ce que tu es déjà accompagnée pour leur rédaction, ou est-ce que tu souhaites l'être sur cette partie ? »",
      "« Le site est-il prévu uniquement en anglais ou est-ce que tu souhaites plusieurs langues ? »",
      "",
      ...
      "« Concernant les visuels, est-ce que tu disposes déjà d'une banque d'images de qualité autour du projet et des technologies développées : photos, rendus 3D, illustrations, schémas ? »",
      "Puis si nécessaire :",
      ...
      "« La charte que tu vas me fournir comprend-elle aussi un univers graphique plus développé, par exemple des éléments graphiques, illustrations, iconographie ou règles de mise en page, ou essentiellement le logo, les couleurs et les typographies mentionnés dans le cahier des charges ? »",
      "Puis :",
      "« S'il s'agit principalement de ces éléments de base, est-ce que tu attends que je développe davantage l'univers graphique pour son application au site ? »",
      "",
      "⑧ WORDPRESS ET CONTRAINTES TECHNIQUES",
      "Ne demande pas quel CMS ils veulent : annonce le tien.",
      "« De mon côté, je conçois et développe mes sites sous WordPress. Est-ce que tu as des contraintes particulières concernant le CMS ou est-ce que WordPress te convient ? »",
      "Puis :",
      ...
      "« En dehors des actualités et des résultats qui évolueront au fil du projet, est-ce que tu souhaites pouvoir modifier toi-même d'autres parties du site ? »",
      "« Est-ce que tu souhaites que je prévoie une formation à la prise en main du site lors de la livraison ? »",
      "",
      "⑩ QUI VALIDE",
      ...
      "« Concernant les validations, est-ce que tu seras mon interlocutrice principale et est-ce que les différents retours seront centralisés de ton côté avant de m'être transmis ? »",
      "Si non :",
      "« Qui devra intervenir dans les différentes validations ? »",
      "",
      "⑪ LA MAINTENANCE · point sensible",
      "Leur enveloppe est de 1 500 € pour trois ans, ton forfait habituel de 120 €/mois représenterait 4 320 €. Le cahier des charges ne dit pas ce que l'enveloppe couvre. NE COMMENCE PAS par dire que leur budget est insuffisant : fais-lui définir le besoin d'abord.",
      "« J'ai vu que tu avais prévu une maintenance pendant les trois années du projet. Qu'est-ce que tu attends précisément derrière cette maintenance : uniquement le suivi technique du site, ou est-ce que tu souhaites aussi prévoir des interventions et modifications ponctuelles ? »",
      ...
      "« Pour que je puisse construire un planning réaliste jusqu'au 18 décembre, est-ce que tu as déjà une idée de la date à laquelle la charte graphique, les textes et les différents contenus pourront m'être transmis ? »",
      "Et éventuellement :",
