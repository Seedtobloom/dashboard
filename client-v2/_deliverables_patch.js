 ...
 */
  ...
  window.stbRevisionModal = function(pid, id){
    ...
    ov.innerHTML = '<div style="background:#fff;border-radius:16px;max-width:540px;width:100%;padding:26px;box-shadow:0 24px 70px -24px rgba(0,0,0,0.45);max-height:92vh;overflow:auto">' +
      ...
      '<div style="font-size:13px;color:var(--muted,#F8F6F2);line-height:1.5;margin-bottom:16px">Explique ce qui doit être modifié. Tu peux joindre des fichiers (visuels annotés, exemples…) et un lien.</div>' +
      ...
      '<label style="display:block;margin-top:11px;font-size:13px;color:var(--terre,#110704)">Pour quelle date veux-tu la nouvelle version&nbsp;? <span style="color:var(--muted,#F8F6F2)">(optionnel)</span><input id="_stbrev-date" type="date" style="display:block;width:100%;box-sizing:border-box;margin-top:6px;padding:11px 15px;border:1px solid #F8F6F2;border-radius:11px;font-size:14px;color:var(--navy,#110704)"></label>' +
